...
{
    public partial class DoctorPortalSupport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.txtName.Text = this.Return_DoctorsName();
            this.txtEmail.Text = this.Return_DoctorsEMailAddress();
        }
        ...
        {
            return String.Format("Website - Doctor Portal Support");
        }
