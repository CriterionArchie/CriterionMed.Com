<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductNMS.aspx.cs" Inherits="CriterionMedCom_Web.ProductNMS" %>
    ...
    <body id="top">
        <form id="form1" runat="server">
            ...
            <main class="main-content">
                <div class="main-product-banner nms-banner">
                    <div class="container default-width">
                        <div class="product-banner-inner">
                            <div class="product-banner-left">
                                <strong>ADVANCE MUSCLE STIMULATION</strong>
                                <span class="title">Introducing the new <br> Criterion Med NMS</span>
                ...
                <div class="empty-banner ">
                    <div class="container">
                        ...
                        <p>
                            stimulate <strong><em>muscle</em></strong> on the <strong><em>go</em></strong>
                        </p>
                        <button class="btn btn-success btn-lg">Request NMS</button>
                        <p class="text-small">
