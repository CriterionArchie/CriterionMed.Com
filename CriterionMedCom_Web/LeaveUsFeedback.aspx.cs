...
{
    public partial class LeaveUsFeedback : System.Web.UI.Page
    {
        ...
        {
            return String.Format("Website - Leave Us Feedback");
        }
        ...
        private string EmailMessage()
        {
            ...
            emailMessage.Append("<br />");
            emailMessage.Append("<u><strong>Website - Leave Us Feedback</strong></u>");
            emailMessage.Append("<br />");
        ...
        private void SendEmail()
        {
            ...
            using (MyDataClassesDataContext myDb = new MyDataClassesDataContext())
            {
                ...
                {
                    mailFromDisplay = "Website - Leave Us Feedback";
