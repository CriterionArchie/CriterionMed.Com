<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductCaseStudies.aspx.cs" Inherits="CriterionMedCom_Web.ProductCaseStudies" %>
...
<html class="no-js">
    <!--<![endif]-->
    <head>
        <title>Products | Case Studies</title>
       ...
       <main class="main-content">
            ...
            <div class="container default-width product-video-section">
                <div class="vitural-table">
                    <div class="left-column">
                        <h4>Say No to Drugs & Surgery</h4>
                        <p>It is an effective and safe alternative to prescription, pain control <br> medication with NO known side-effects or risk of overdose.</p>
                ...
                <div class="vitural-table">
                    ...
                    <div class="right-column">
                        ...
                        <p>Proven, cost-effective, non-invasive medical solutions <br> for pain management</p>
                        <p><a href="#">LEARN MORE</a></p>
                    </div>
                </div>
            </div>
            <div class="empty-banner">
                <div class="container">
                    ...
                    <p>on-demand <strong><em>pain</em></strong> relief and <strong><em>control</em></strong></p>
